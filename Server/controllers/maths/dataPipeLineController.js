...
// // // //                 quizResults: "$quizResults", // Debugging: Get full quiz results
...
// // //             // Lookup latest quiz results data by ensuring it's from the latest quiz
// // //             {
// // //                 $lookup: {
// // //                     from: "quizresults",
// // //                     let: { latestQuizId: "$_id", childId: "$childId" },
// // //                     pipeline: [
// // //                         { 
// // //                             $match: { 
// // //                                 $expr: { 
// // //                                     $and: [
// // //                                         { $eq: ["$childId", "$$childId"] }, // Match child
// // //                                         { $eq: ["$quizId", "$$latestQuizId"] } // Ensure it's from the latest quiz attempt
// // //                                     ]
// // //                                 }
// // //                             } 
// // //                         },
// // //                         { $sort: { createdAt: -1 } }, // Ensure latest quiz result is picked
// // //                         { $limit: 1 }
// // //                     ],
// // //                     as: "quizResults"
// // //                 }
// // //             },
// // //             { $unwind: { path: "$quizResults", preserveNullAndEmptyArrays: true } }, // Unwind latest quiz results safely
...
// // //                     avrgresponsetimeforsublevel3questions: "$avgResponseTimeForSubLevel3",
// // //                     avrgresponsetimeforsublevel4questions: "$avgResponseTimeForSubLevel4",
// // //                     // quizmark: { $ifNull: ["$quizResults.quizMark", 0] }, // Get correct quiz mark or 0
// // //                     // quizcompletationtime: { $ifNull: ["$quizResults.completionTime", 0] } // Get correct time or 0
// // //                 // In your $project stage, modify these two lines:
// // //                     quizmark: { $ifNull: ["$quizResults.quizMark", 0] }, // Use $ifNull for quizMark too
// // //                     quizcompletationtime: { $ifNull: ["$quizResults.completionTime", 0] }
// // //                 }
// // //             }
// // //         ]);
...
// //                     avrgresponsetimeforsublevel3questions: "$avgResponseTimeForSubLevel3",
// //                     avrgresponsetimeforsublevel4questions: "$avgResponseTimeForSubLevel4",
// //                     quizmark: { $ifNull: [{ $arrayElemAt: ["$quizResults.quizMark", 0] }, 0] }, // Use $arrayElemAt to access the first element
// //                     quizcompletationtime: { $ifNull: [{ $arrayElemAt: ["$quizResults.completionTime", 0] }, 0] } // Use $arrayElemAt to access the first element
// //                 }
// //             }
// //         ]);
...
router.get('/getModelData', async (req, res) => {
    ...
    try {
        ...
        const data = await Quiz.aggregate([
            ...
            // Lookup latest quiz results data by matching childId, category, and difficulty
            {
                $lookup: {
                    from: "quizresults",
                    let: { 
                            ...
                            $match: { 
                                $expr: { 
                                    $and: [
                                        ...
                                        { $eq: ["$difficulty", "$$difficulty"] } // Match difficulty
                                    ]
                                }
                            } 
                        },
                        { $sort: { date: -1 } }, // Ensure latest quiz result is picked (using date field from your schema)
                        { $limit: 1 }
                    ],
                    as: "quizResults"
                }
            ...
            // Group and structure final data
            {
                $project: {
                    ...
                    avrgresponsetimeforsublevel3questions: "$avgResponseTimeForSubLevel3",
                    avrgresponsetimeforsublevel4questions: "$avgResponseTimeForSubLevel4",
                    quizmark: { $ifNull: ["$quizResults.quizMark", 0] }, // Simplified since $unwind already flattened the structure
                    quizcompletationtime: { $ifNull: ["$quizResults.completionTime", 0] } // Simplified since $unwind already flattened the structure
                }
            }
        ]);
