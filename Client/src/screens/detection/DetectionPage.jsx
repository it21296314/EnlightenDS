...
//VERY FINAL CORRECT CODE WITHOUT BOUNDARY
// import React, { useState, useRef, useCallback } from 'react';
// import ReactWebcam from 'react-webcam';
// import axios from 'axios';
// import './DetectionPage.css';
...
//                     </>
//                   ) : (
//                     <div className="no-detection-animation">
//                       <div className="checkmark-animation">
//                         <div className="checkmark-circle"></div>
//                         <div className="checkmark-stem"></div>
//                         <div className="checkmark-kick"></div>
//                       </div>
//                       <p className="no-detection-message">No indicators of Down Syndrome detected in this image.</p>
//                       <p className="medical-disclaimer">Remember that this is an educational tool and not a medical diagnosis.</p>
//                     </div>
//                   )}
//                 </div>
                ...
                <div className="results-text">
                  ...
                  {prediction.label === "Down Syndrome Detected" ? (
                    ...
                    <div className="no-detection-animation">
                      ...
                      <p className="no-detection-message">Image is not frontal or landmarks are insufficient or unsupported image</p>
                      <p className="medical-disclaimer">Please try again with a clear frontal face image.</p>
                    </div>
                  ) : (
                    <div className="no-detection-animation">
                      <div className="checkmark-animation">
